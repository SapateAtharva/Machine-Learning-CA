...
* **Classification Report (Model 1):**
    ...
    ```
* **Analysis:** The CNN model was weakest on **Ferrari**, showing a low recall (0.63). This indicates it missed many Ferrari images. It also had a high tendency to misclassify other cars as **Mercedes** (92% recall but only 72% precision).
...
*  ![Final Comparison](final_comparison_chart.png)
